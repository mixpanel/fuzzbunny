 ...
 * // [`my`, ` `, `ex`, `ample `, `str`, `ing`]
 */
function stringFilterMatches(targetStr, searchStr) {
  const match = fuzzyMatch(targetStr, searchStr);
  console.log(targetStr, searchStr, match && match.matchParts);
  return match && match.matchParts;
}

module.exports = {stringFilterMatches, fuzzyMatch, fuzzyMatchSanitized, matchPartsFromSegments};
